rm $1.hsaco $1.hex
~/iree-build/llvm-project/bin/clang -x hip --offload-arch=gfx950 --offload-device-only -nogpulib -D_ALLOW_COMPILER_AND_STL_VERSION_MISMATCH -O3 -fvisibility=protected -emit-llvm -c $1 -o $1.bc
...
~/iree-build/llvm-project/bin/clang -target amdgcn-amd-amdhsa -mcpu=gfx950 -c $1.linked.bc -o $1.o
